...
class KeuanganController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $tanggalBayarList = $penghuni->pluck('tanggal_bayar', 'id');
        $selectedPenghuni = $request->get('id_penghuni');
        $defaultTanggalBayar = $selectedPenghuni ? ($tanggalBayarList[$selectedPenghuni] ?? '') : '';
        return view('keuangan.create', compact('penghuni', 'tanggalBayarList', 'selectedPenghuni', 'defaultTanggalBayar'));
    }
